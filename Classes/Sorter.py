...
'''
Description:
This is the Sorter file which includes a Sorter class, currently having implemented a merge sort as the 
...
class Sorter:
    ...
    def merge_sort(arr):
        ...
        if len(arr) > 1:
            ...
            Sorter.merge_sort(left_half)
            Sorter.merge_sort(right_half)
